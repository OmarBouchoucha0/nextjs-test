...
export default function Navbar() {
    return (
        <nav className="sticky top-0 z-50 bg-white/95 transition-all hover:bg-white/100 border-b">
            <div aria-describedby="this is the navigation bar" className="flex justify-between items-center  h-[4vw]">
                <div className="order-1 p-4 items-center">
                    ...
                    <NavigationMenu>
                        <NavigationMenuList className="gap-1">
                            ...
                            <NavigationMenuItem className=''>
                                <NavigationMenuLink href="/dashboard" className="flex items-center gap-1">
                                    Admin Dashboard
                                </NavigationMenuLink>
                            </NavigationMenuItem>
                        </NavigationMenuList>
                ...
                <div className="order-2 w-full sm:w-[70vw] md:w-[50vw] lg:w-[40vw]">
                    <div className="relative flex items-center">
                        <Input
                            type="text"
                            placeholder="Search For A Model"
                            className="w-full pr-10 pl-4 
        py-2  md:py-2  xl:py-2
        h-10  md:h-7 lg:h-9 xl:h-10
        rounded-xs border-gray-300 focus:ring-2 
        text-sm "
                        />
                        <Search className="absolute right-3 h-4 w-4 sm:h-5 sm:w-5 text-gray-400 pointer-events-none" />
                    </div>
                </div>
